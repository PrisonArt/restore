...
describe('Justice', () => {
  ...
  async function deployJustice(payment: SignerWithAddress, fund: SignerWithAddress, deployer?: SignerWithAddress) {
  ...
  it('should allow pr1s0nart to create an auction', async () => {
    ...
    const payment = ethers.BigNumber.from(70);
    ...
    let endCalc = auction.startTime.toNumber() + DURATION;
