...
@Component({
  selector: 'pr1s0nart-host-for-test',
  template: ''
})
class HostComponent {
  actionHandler = () => {};
...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<pr1s0nart-big-input-action></pr1s0nart-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<pr1s0nart-big-input-action [disabled]="true"></pr1s0nart-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<pr1s0nart-big-input-action fontSet="fas" fontIcon="trash"></pr1s0nart-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<pr1s0nart-big-input-action label="delete"></pr1s0nart-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<pr1s0nart-big-input-action (action)="actionHandler()"></pr1s0nart-big-input-action>';
    fixture = createHostComponent(template);
